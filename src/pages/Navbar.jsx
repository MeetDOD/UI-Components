...
const Navbar = () => {
  return (
    <div>
      <header>
    <nav class="navbar navbar-expand-lg fixed-top bg-black meet" data-offset="500">
      <div class="container">
        <a href="#" class="navbar-brand text-secondary">Seo <span class="text-primary">Gram.</span></a>
